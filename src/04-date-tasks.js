...
function timeSpanToString(startDate, endDate) {
  ...
  return `${hour.toString().padStart(2, '0')}:${minutes.toString().padStart(2, '0')}:${seconds.toString().padStart(2, '0')}.${milliSeconds.toString().padStart(3, '0')}`;
}
...
function angleBetweenClockHands(date) {
  ...
  const angle = Math.abs(((60 * hours + minutes) * 0.5) - (6 * minutes)) % 360;
